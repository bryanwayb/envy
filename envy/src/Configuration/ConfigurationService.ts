    ...
    async GetConfiguration(): Promise<ConfigurationModel> {
        ...
        try {
            if (!this._configurationModel) {
                ...
                const defaultConfiguration = await this._yamlSerializationService.LoadStructuredYamlFromFile(ConfigurationModel, defaultConfigurationFilePath);
                ...
                if (configurationFilePath
                    ...
                    const suppliedConfiguration = await this._yamlSerializationService.LoadStructuredYamlFromFile(ConfigurationModel, configurationFilePath);
